...
// 打字效果
var arr = [
    { type: 'text', text: '泻药，马丽凯，又名马丽凯，是个十足的女神经，嗯？' },
    { type: 'wait', time: 900 },
    { type: 'delete', num: 4 },
    { type: 'text', text: '，嗯!' },
    { type: 'br' },
    ...
    { type: 'wait', time: 500 },
    { type: 'br' },
    { type: 'img', src: 'img/1.jpg', id: "cat", style: "width: 50%;display: block;margin-left: auto;margin-right: auto;margin-top: 20px;margin-bottom: 20px;" },
